<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Member.Master" AutoEventWireup="true" CodeBehind="Website.aspx.cs" Inherits="Tag.Website.Website" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        ...
        Dtowebsite.WebSiteName = textInfo.ToTitleCase(Dtowebsite.WebSiteName);
    %>
    <div style="width: 100%; height: 100%; text-align: center; font-weight: bold; color: black;">
        <h1><%= Dtowebsite.WebSiteName %></h1>
    </div>
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 70%;">
                        ...
                        <iframe id="iframeWebsiteFeed" src="WebsiteFeed.aspx?TagId=<%= Tagstring %>&EmoId=<%=Emostring %>&Id=<%= Convert.ToInt64(ViewState["UserID"]) %>&WebsiteId=<%= Convert.ToInt64(ViewState["websiteId"]) %>" style="width: 100%; border: none;" onload='javascript:resizeIframe(this);'></iframe>
                    </td>
                    <td class="tagcolumn" style="width: 30%; background-color: #ecf9d4;">
                          <div class="panel-group" id="accordion">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" style="text-decoration: none;" data-parent="#accordion" href="#collapseOne">Tag  
                                            <% if (Lsttag != null)
                                               {
                                                   if (Lsttag.Count > 0)
                                                   {
                                    ...
                                    <div class="panel-body">
                                        <ul class="unorderlist">
                                            ...
                                            <li style="display: inline-block;">
                                                ...
                                                <br />
                                                <span class="checkoutbutton"><a id="anchor<%= tag.TagId%>" style="cursor: pointer; color: white; text-decoration: none;" href="javascript:opentag('<%= tag.TagId%>','<%=tag.TagName%>')">&nbsp;&nbsp;&nbsp;<%= tag.TagName%></a>&nbsp;&nbsp;&nbsp;</span>
                                            </li>
                                            <%}
                                        }%>
                                        </ul>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" style="text-decoration: none;" data-parent="#accordion" href="#collapseTwo">Emotion 
                                            <% if (Lstemotions != null)
                                               {
                                    ...
                                    <div class="panel-body">
                                        <ul class="unorderlist">
                                            ...
                                            <li style="display: inline-block;">
                                                ...
                                                <br />
                                                <span class="checkoutbutton"><a id="anchor<%=emo.Emotionid%>" style="cursor: pointer; color: white; text-decoration: none;" href="javascript:openemo('<%=emo.Emotionid%>','<%= emo.EmotionName%>')">&nbsp;&nbsp;&nbsp;<%= emo.EmotionName%></a>&nbsp;&nbsp;&nbsp;</span>
                                            </li>
                                            <%}
                                       }%>
                                        </ul>
    ...
    <script type="text/javascript">
        function DeleteTag(tagid, tagname) {
            ...
            if (hdntagidarray.value.length > 0 || hdnemoidarray.value.length > 0) {
                document.getElementById('iframeWebsiteFeed').src = 'WebsiteFeed.aspx?WebsiteId=<%=Convert.ToInt64(ViewState["websiteId"]) %>&Id=<%= Convert.ToInt64(ViewState["UserID"])%>&TagId=' + hdntagidarray.value + '&EmoId=' + hdnemoidarray.value;
            }
            else {
                document.getElementById('iframeWebsiteFeed').src = 'WebsiteFeed.aspx?WebsiteId=<%=Convert.ToInt64(ViewState["websiteId"]) %>&Id=<%= Convert.ToInt64(ViewState["UserID"])%>&TagId=<%= Tagstring %>&EmoId=<%= Emostring %>';
            }
        }
        ...
        function opentag(tagid, tagname) {
            ...
            if (hdn.value.length > 0) {
                ...
                div.innerHTML += "<span class='checkoutbutton' style='color: black;padding: 5px;border: 1px solid gainsboro;'><a id='anchor" + tagid + "' style='text-decoration: none;'>" + tagname + "&nbsp;&nbsp;&nbsp;<img id='img" + tagid + "' onclick='DeleteTag(&quot;" + tagid + "&quot;,&quot;" + tagname + "&quot;)' src= 'http://www.glozzary.com/Images/tagclose.png' style='cursor:pointer;' /></span>&nbsp;";
        ...
        function openemo(emoid, emoname) {
            ...
            if (hdn.value.length > 0) {
                ...
                div.innerHTML += "<span class='checkoutbutton' style='color: black;padding: 5px;border: 1px solid gainsboro;'><a id='anchor" + emoid + "' style='text-decoration: none;'>" + emoname + "&nbsp;&nbsp;&nbsp;<img id='img" + emoid + "' onclick='DeleteEmo(&quot;" + emoid + "&quot;,&quot;" + emoname + "&quot;)' src= 'http://www.glozzary.com/Images/tagclose.png' style='cursor:pointer;' /></span>&nbsp;";
