<%@ Page Title="" Language="C#" MasterPageFile="~/WebsiteAdmin/WebsiteAdmin.Master" AutoEventWireup="true" CodeBehind="WebsiteGeneralSetting.aspx.cs" Inherits="Tag.WebsiteAdmin.WebsiteGeneralSetting" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <table style="-webkit-border-radius: 15px; background-color: white; border-collapse: collapse; padding: 0px; width: 100%;">
        <%--<tr>
            <td colspan="2" style="font-size: 18px; font-weight: bold; text-align: center; width: 100%;"><br />Website/ Blog
                <hr />
            </td>
        </tr>--%>
        <tr>
            <td>
                <table style="padding: 0px; width: 100%;">
                        ...
                        <td colspan="3">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <h4>Logo</h4>
                                    <asp:Image ID="imgweblogo" runat="server" ImageUrl="../Images/no-img-available-icons.jpg" Style="height: 150px; width: 150px;" /> 
                                    <asp:FileUpload ID="ImgUpload" runat="server" Style="display: inline;" />
                                    <asp:Label ID="lbluplderrmsg" runat="server" ForeColor="Red"></asp:Label>
                                  <br/><br/>
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control textbox" placeholder="Short Name" Style="width: 400px;" /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="WebsiteName Required" ForeColor="Red" ValidationGroup="A">*</asp:RequiredFieldValidator> 
                                    <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control textbox" placeholder="Website / Blog Url" Style="width: 400px;" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="Website Url Required" ForeColor="Red" SetFocusOnError="True" ValidationGroup="A">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox2" ErrorMessage="Url Not in correct format" ForeColor="Red" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&amp;=]*)?" ValidationGroup="A">*</asp:RegularExpressionValidator>
                                    <span class="help-block"><strong>Correct Format:</strong> http://www.google.com</span>
                                    <p><strong>Type</strong></p>
                                    <asp:DropDownList ID="dplstwebsitetype" CssClass="form-control textbox" runat="server" Width="370px" OnSelectedIndexChanged="dplstwebsitetype_SelectedIndexChanged" AutoPostBack="True" DataValueField="WebsiteID" DataTextField="WebsiteName">
                                    </asp:DropDownList>&nbsp;<asp:CompareValidator ID="RequiredFieldValidator10" runat="server" ValueToCompare="0" ControlToValidate="dplstwebsitetype" ErrorMessage="*" ForeColor="Red" ValidationGroup="A" Operator="NotEqual"></asp:CompareValidator>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" style="color: #141823; font-family: Helvetica, Arial, 'lucida grande', tahoma, verdana, arial, sans-serif; font-size: 18px; font-weight: bold; text-align: center; width: 100%;">Services
                            <hr />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="color: #141823; font-family: Helvetica, Arial, 'lucida grande', tahoma, verdana, arial, sans-serif; font-size: 18px; font-weight: bold; text-align: center; width: 100%;">Meta-Character
                            <hr />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="padding: 10px 10px 10px 10px">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <textarea id="txtrecommended" runat="server" enableviewstate="true" style="height: 150px; width: 100%;" class="textbox" disabled="disabled"></textarea><br/><br/>
                                    <p><strong>Optional</strong></p>
                                    <textarea id="txtoptional" enableviewstate="true" runat="server" style="height: 150px; width: 100%;" class="textbox" disabled="disabled"></textarea>
                ...
                <div style="text-align: center;">
                    <asp:Button ID="BtnRegister" runat="server" OnClick="Button1_Click" Visible="false"
                                CssClass="btn btn-default" Text="Register" ValidationGroup="A" />
                    <asp:Button ID="BtnDone" runat="server" OnClick="Button1_Click1" Visible="false"
                                CssClass="btn btn-default" Text="  Save  " ValidationGroup="A" />
                </div>
                <br/>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="color: #141823; font-family: Helvetica, Arial, 'lucida grande', tahoma, verdana, arial, sans-serif; font-size: 18px; font-weight: bold; text-align: center; width: 100%;">Code
                <hr />
            </td>
        </tr>
        <tr>
            <td colspan="3" style="padding: 10px 10px 10px 10px">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <textarea id="txtcode" runat="server" style="height: 150px; width: 100%;" class="textbox" disabled="disabled"></textarea>
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3" style="color: #141823; font-family: Helvetica, Arial, 'lucida grande', tahoma, verdana, arial, sans-serif; font-size: 18px; font-weight: bold; text-align: center; width: 100%;">
                <hr />
                END
            </td>
        </tr>
